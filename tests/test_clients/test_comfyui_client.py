...
class TestComfyUIClient:
    ...
    def test_check_availability_success(self, mock_get):
        ...
        mock_get.assert_called_once_with("http://192.168.1.215:8188/system_stats", timeout=5)
    ...
    def test_get_available_models_success(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "CheckpointLoaderSimple": {"input": {"required": {"ckpt_name": [["model1.safetensors", "model2.ckpt"]]}}},
    ...
    def test_queue_prompt_success(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"prompt_id": "test-prompt-id-12345"}
    ...
    def test_get_history_success(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "prompt-id-123": {"outputs": {"node_1": {"images": [{"filename": "test.png"}]}}}
        }
        mock_get.return_value = mock_response
