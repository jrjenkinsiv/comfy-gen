...
|----------|-------------|
| [USAGE.md](docs/USAGE.md) | Comprehensive usage guide: CLI, MCP, prompts, validation |
| [ARCHITECTURE.md](docs/ARCHITECTURE.md) | System architecture, workflows, presets, LoRAs, metadata |
