...
@click.option("--lora", multiple=True, metavar="NAME:STRENGTH", help="Add LoRA with strength (e.g., 'style.safetensors:0.8')")
...
@click.option("--retry-strategy", type=click.Choice(['progressive', 'seed_search', 'prompt_enhance']), 
              default='progressive', help="Retry strategy")
...
@models.command("list")
@click.option("--type", "model_type", type=click.Choice(['checkpoints', 'loras', 'vae', 'all']), 
...
@click.option("--source", type=click.Choice(['civitai', 'huggingface']), required=True, 
